...
pub type PositionKalmanFilterDeprecatedf32 = PositionKalmanFilterDeprecated;
...
pub struct PositionKalmanFilterDeprecated {
...
impl Default for PositionKalmanFilterDeprecated {
    fn default() -> Self {
        Self::new()
    }
}
...
#[allow(missing_docs)]
impl PositionKalmanFilterDeprecated {
...
mod test_traits {
    ...
    #[test]
    fn normal_types() {
        is_full::<PositionKalmanFilterDeprecated>();
    }
}
